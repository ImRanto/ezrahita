...
export const events = [
  { id: "1", day: "14", month: "Nov", date: "14 novembre 2026", type: "Concert", title: "Concert de fin d'année", location: "Palais des Sports, Antananarivo", description: "Notre grand concert annuel réunissant l'ensemble du répertoire travaillé cette année.", image: scene("event-concert-1", 900, 600) },
  ...
  { id: "4", day: "18", month: "Jan", date: "18 janvier 2027", type: "Festival", title: "Festival des chœurs de Madagascar", location: "Alliance Française, Antananarivo", description: "Ezrahita participe à ce grand rassemblement de chorales venues de tout le pays.", image: scene("event-festival-1", 900, 600) },
  { id: "5", day: "07", month: "Fév", date: "7 février 2027", type: "Communauté", title: "Journée portes ouvertes", location: "Local de répétition, Ambohipo", description: "Venez rencontrer les choristes, visiter nos locaux et assister à une répétition ouverte.", image: scene("event-portes-1", 900, 600) },
  { id: "6", day: "21", month: "Mar", date: "21 mars 2027", type: "Rencontre", title: "Rencontre inter-chorales", location: "Centre culturel Albert Camus", description: "Un moment d'échange musical avec deux autres ensembles vocaux de la capitale.", image: scene("event-rencontre-1", 900, 600) },
  { id: "7", day: "09", month: "Mai", date: "9 mai 2027", type: "Concert", title: "Concert de printemps", location: "Institut Français de Madagascar", description: "Un programme tout en légèreté pour célébrer l'arrivée des beaux jours.", image: scene("event-concert-2", 900, 600) },
];
