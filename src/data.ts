...
// Adresse e-mail de contact du site (affichée dans le footer et sur la page Contact).
export const contactEmail = "ezrahita.ambohimanandray@gmail.com";
...
export const members = [
  ...
  { id: "12", category: "Choriste", firstName: "Ranto", name: "Ranto", role: "Tenor", joined: "2020",voice: "3e", image: portrait("ranto"), bio: "Jeunes tenors actifs" },
  ...
  { id: "17", category: "Musicien", firstName: "Fitahiana", name: "Fitahiana", role: "Musicien", instrument: "Guitare basse et Piano", voice: "3e", image: musicianPortrait("Fitahiana"), bio: "Fitahiana met son oreille musicale au service du groupe, entre accompagnement et arrangements." },
  { id: "18", category: "Musicien", firstName: "Kiki", name: "Kiki", role: "Musicien", instrument: "Piano", voice: "3e", image: musicianPortrait("Kiki"), bio: "Kiki complète l'ensemble et veille à l'équilibre sonore pendant les concerts." },
  { id: "19", category: "Musicien", firstName: "Ranto", name: "Ranto", role: "Musicien", joined: "2024", instrument: "Guitare", voice: "3e", image: musicianPortrait("Ranto"), bio: "Ranto chante parmi les ténors et accompagne le groupe sur scène." },
  { id: "20", category: "Musicien", firstName: "Setra", name: "Setra", role: "Musicien", joined: "2010", instrument: "Trompette", voice: "Basse", image: musicianPortrait("Setra"), bio: "Setra accompagne le chœur depuis 2010 et compte parmi les musiciens historiques du groupe." },
];

export const events = [
  { id: "10", day: "14", month: "Nov", date: "14 Novembre 2026", type: "Concert", title: "Grand concert annuel", location: "FJKM Ambohimanandray Filadelfia, Antananarivo", description: "On vous donne rendez-vous le 14 Novembre 2026 Comme chaque année pour célebrer notre 65ème Anniversaire, Venez nombreux !", image: concert("concert-7", 900, 600), featured: true },
  ...
  { id: "6", day: "21", month: "Mar", date: "21 mars 2026", type: "Communauté", title: "Tournoi de Foot FIOMBONANA ", location: "FJKM Ambohimanandray Filadelfia, Antananarivo", description: "Un moment d'échange sportif.", image: scene("scene-21", 900, 600) },
